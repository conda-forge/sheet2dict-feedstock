...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sheet2dict-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12555&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sheet2dict-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sheet2dict` can be installed with:

```
conda install sheet2dict
```

It is possible to list all of the versions of `sheet2dict` available on your platform with:
